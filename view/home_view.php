            ...
            <div class="col-md-4">
              <div class="cardcontainer">
                ...
                <img src="<?php echo $row['image']; ?>">
                  <div class="type2"><?php echo $row['temperature']; ?></div>
                </div>
                <div class="content">
                  <p class="txt4"><?php echo $row['name']; ?></p>
                </div>
                <div class="footer">
                  <p class="txt3">Price: <i class="fas fa-dollar-sign"></i><?php echo $row['price']; ?></p>
                </div>
              </div>
            </div>
          <?php endforeach; ?>
